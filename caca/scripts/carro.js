class Carro {
    ...
    mostrarCarro() {
        ...
        // Mostrar el botón "Confirmar Compra" solo si hay artículos en el carrito
    ...
    confirmarCompra() {
        ...
        // Mostrar mensaje de confirmación con todos los datos del cliente
        ...
        confirmationMessage.innerHTML = `
            ...
            Recibirás tu pedido dentro de 5 días.
        `;
        confirmationMessage.style.display = "block";

        // Simular el envío de correo (alerta)
        setTimeout(() => {
